            ...
            <CollapsibleContent>
              <div className="px-6 pb-6 -mt-2 border-t border-border/40 pt-4 space-y-3 text-xs text-foreground/85 leading-relaxed">
                ...
                <div className="space-y-3">
                  ...
                  <p>
                    <span className="text-money font-semibold">• Financial Phase:</span> Beyond the site's main Earn-to-Learn potential, users will be able to invest their own money Safely Alongside their Vaulted Time-Credit thanks to <strong className="text-foreground">Kiln & Anchorage Digital Financial Services</strong>. All Real-World Currency investments from users' Own Personal Finances will be withdrawable at any time without any limitations, except for the Limits brought from the Controls & Regulations associated with Anti Money Laundering All the Financial Services Require in order to Operate Legally.
                  </p>
                  <p>
