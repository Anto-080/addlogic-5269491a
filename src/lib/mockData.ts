...
export const TIERS = [
  ...
  { id: 19, name: "Sciences",                              icon: "🧪", multiplier: 8.0,  color: "hsl(250, 55%, 52%)", researchers: 2900, avgEarning: 34.00, locked: false, subcategories: ["Chemistry", "Botany", "Mathematics"] },
  { id: 20, name: "Energy",                                icon: "⚡", multiplier: 7.8,  color: "hsl(200, 60%, 48%)", researchers: 2750, avgEarning: 33.00, locked: false, subcategories: ["Electromagnetic Induction", "Fuels", "Renewables"] },
